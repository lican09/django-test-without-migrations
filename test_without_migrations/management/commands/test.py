...
class Command(TestCommand):
    ...
    def add_arguments(self, parser):  # New API on Django 1.8
        parser.add_argument(
            '-nm', '--nomigrations', action='store_true', dest='nomigrations',
            default=False,
            help='Tells Django not to use migrations before creating tables for tests.'
        )
    ...
    def handle(self, *test_labels, **options):
        ...
        print("-nm, --nomigrations:", options['nomigrations'])
